...
spatial local launch C:\git\UE4_425\Samples\UnrealGDKExampleProject\Game\Intermediate\Improbable\Control_Small_LocalLaunchConfig.json --snapshot=snapshots/default.snapshot --runtime_version=0.4.3

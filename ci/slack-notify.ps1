...
# $android_succeed = Get-Meta-Data -variable_name 'firebase-android-succeed' -default_value "1"
# $android_total = Get-Meta-Data -variable_name 'firebase-android-total' -default_value "2"
# $ios_succeed = Get-Meta-Data -variable_name 'firebase-ios-succeed' -default_value "3"
# $ios_total = Get-Meta-Data -variable_name 'firebase-ios-total' -default_value "4"
